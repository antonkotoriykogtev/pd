<template>
  ...
  <div class="row">
    ...
    <div v-show="UserNoSettings" class="container is-max-desktop EventContainerMargin" >
      ...
      <div class="columns is-mobile">
        <div class="column is-half ">
          <figure class="image is-128x128">
            <img :src="profile.picture_link" class='slider-img'  ratio="6by4" alt=" ">
          </figure>
        </div>
      </div>
      <div class="columns is-mobile">
      ...
      <b-button v-on:click="OpenUserSettings">Изменить информацию аккаунта</b-button>
    </div>

    <div v-show="UserSettings" class="container is-max-desktop EventContainerMargin" >
      <form v-on:submit.prevent="SaveUserInfo">
        <p class="creator_title">Имя</p>
        <input name="eventName" :placeholder="profile.picture_link" type="text" v-model="profile.name">
        <b-field label="Name">
        ...
        <p class="creator_title">Место проведения:</p>
        <input name="eventMap" placeholder="Введите место проведения" type="text" v-model="profile.address">

        <button class=" button is-info" type="submit" v-on:click="">Сохранить</button>
